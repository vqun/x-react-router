...
var Link = function (_Component) {
  ...
  function Link() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Link.__proto__ || Object.getPrototypeOf(Link)).call.apply(_ref, [this].concat(args))), _this), _this.jumpTo = function (evt) {
      evt.preventDefault();
