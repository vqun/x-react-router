...
var Router = function (_Component) {
  ...
  function Router() {
    ...
    _this.state = { routes: [], location: (0, _HistoryUtils.createRouterFromLocation)(window.location) };
  ...
  _createClass(Router, [{
    ...
    value: function init() {
      ...
      this.props.history.listen(function (location) {
        return _this2.setState({ location: (0, _HistoryUtils.createRouterFromLocation)(location) });
      });
    }
  }]);
