...
var Router = function (_Component) {
  ...
  _createClass(Router, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      this.createRouter(nextProps, (this.shouldUpdate = !!preload && preload === 'true') && script.getAttribute('src'));
    }
  }, {
    ...
    key: 'createRouter',
    value: function createRouter(props, preload) {
      var children = props.children,
          prefix = props.prefix,
          Routing = props.Routing;

      if (preload && preload === 'true') Routing.compile(children, new Routing({ originalPath: prefix }), preload);else Routing.merge(children, new Routing({ originalPath: prefix }));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return render({ Routing: Routing, location: location });
    }
  }, {
    key: 'init',
    value: function init() {
