...
var _RouterModes2 = _interopRequireDefault(_RouterModes);
...
var Router = function (_Component) {
  ...
  function Router(props, context) {
    ...
    _this.state = { location: (0, _history.createHistoryFromLocation)(window.location) };
  ...
  _createClass(Router, [{
    ...
    value: function createRouter(props) {
      ...
      Routing.compile(children, new Routing({ originalPath: prefix }));
    }
  }, {
    key: 'render',
...
Router.defaultProps = {
  ...
  mode: _RouterModes2.default.PATH
};
